...
% For compatibility with biblatex, this package should be loaded now and not later
\usepackage{hyperref}
\hypersetup{hidelinks,colorlinks=true,breaklinks=true,citecolor=darkblue,
linkcolor=darkgray,urlcolor=ocre,bookmarksopen=false,pdftitle={Title},pdfauthor={Author}}
