...
%
% Copyright:
% © GEM Foundation, Pavia, Italy. April 2015.
%
%-------------------------------------------------------------------------------
...
\begin{document}
\input{qareport/glossary.tex} % ---------------------------------- Load glossary -

%-------------------------------------------------------------------------------
%  COVER PAGE
%-------------------------------------------------------------------------------

%\includepdf[pages=-]{figures/oq_risk_qa.pdf}
...
\chapter{Software Testing}
   \label{chap:intro}
   \input{qareport/introduction.tex}
...
\chapter{Framework for Acceptance Testing}
   ...
   \input{qareport/acc-framework.tex}
   \cleardoublepage
...
\chapter{Comparing Loss Curves from the Classical and Event-Based Risk Calculators}
   ...
   \input{qareport/bm-classical-eventbased.tex}
   \cleardoublepage

\chapterimage{figures/chapter_head_2.pdf} % Chapter heading image
\chapter{Comparison with Other Softwares}
   \label{chap:bm-comparison}
   \input{qareport/bm-comparison.tex}
   \cleardoublepage
...
\chapter{Demos}
   ...
   \input{qareport/perf-demos.tex}
   \cleardoublepage
\chapter{Stress Tests}
   \label{chap:perf-stress}
   \input{qareport/perf-stress.tex}
   \cleardoublepage
